...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright JakeRieger, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/jrCompressor-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/jrCompressor-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/jrCompressor-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/jrCompressor-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/jrCompressor-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/jrCompressor-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/jrCompressor-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/jrCompressor.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/jrCompressor.iss",inplace=1):
